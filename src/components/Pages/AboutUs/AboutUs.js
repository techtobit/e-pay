          ...
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            <div>
              <h1 className="inline-block px-3 py-px mb-4 text-2xl font-semibold tracking-wider text-orange-900 dark:text-white uppercase rounded-full bg-teal-accent-400">
                Cyber-6
                <span
                  style={{ color: "rgb(79, 70, 229)", fontWeight: "bold" }}
                >
            ...
            <p className="text-base text-gray-700 dark:text-white md:text-lg select-none">
              ...
              workers to select, pack, and promptly ship customer orders.Our
              Team Leader assignes every works perfectly to ours, and take
              responsibilities specific to the different Fulfillment Center
              areas.
            </p>
          </div>
          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="select-none">
              ...
              >
                <img
                  className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300"
                  src="https://i.ibb.co/r7mgr5d/PROJIT-MONDOL.jpg"
                  alt="Person"
                />
                <h1 className="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white group-hover:text-white">
                  PROJIT MONDOL
